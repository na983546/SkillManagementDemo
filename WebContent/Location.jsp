...
<table>
	<tr>
		...
		<td><input type ='number' name='experience' min="3" placeholder='Greater than Equal to 3' required></td>
	</tr>
</table>

		<input id="button" type="submit" class='my-button' name="action" value="EMPLOYEE">
